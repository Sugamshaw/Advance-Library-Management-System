...
public class StudentDetail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        student_details.setBackground(new java.awt.Color(255, 255, 153));
        student_details.setFont(new java.awt.Font("Bookman Old Style", 0, 14)); // NOI18N
        student_details.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Student's Name", "Parent's Name", "Student's Mob. No,", "Parent's Mob. No.", "Gender", "Date of Birth", "Course Name", "Branch Name", "Address"
            }
        ) {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Student's Name", "Parent's Name", "Student Mobile No.", "Parent Mobile No.", "Gender", "Date of Birth", "Course Name", "Branch name", "Address"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, false, false, false
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img 21.png"))); // NOI18N
        jLabel1.setText("  STUDENT DETAILS");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(62, 58, 352, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql = "SELECT * FROM advance_lms.student_details";
        try {
